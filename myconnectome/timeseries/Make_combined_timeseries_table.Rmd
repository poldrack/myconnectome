...
data_full=data
data=data[abs(data$cor.val)>0.3,]

idx=order(data$pval_bh)

data=data[idx,]
print(kable(data[1:40,c(12,1,13,2,3,4,10,11,12)],row.names=FALSE))

kl=kable(data[1:40,c(12,1,13,2,3,4,10,11,12)],row.names=FALSE,format='latex'))
