...
source('../timeseries/load_myconnectome_data.R')

source('../timeseries/timeseries_helpers.R')

source('../timeseries/est_bivariate_arima_model.R')

thresh=0.05  # FDR threshold
save_latex=TRUE
...
```{r loadData, message=FALSE,warning=FALSE,error=FALSE}
...
```{r BehavBehav,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wincorrBehav,message=FALSE,warning=FALSE,error=FALSE}
...
```{r bwcorrBehav,message=FALSE,warning=FALSE,error=FALSE}
...
```{r netdatBehav,message=FALSE,warning=FALSE,error=FALSE}
...
```{r PIbehav,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wgcnaBehav,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wgcnaWincorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wgcnaBwcorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wgcnaNetdat,message=FALSE,warning=FALSE,error=FALSE}
...
```{r immportBehav,message=FALSE,warning=FALSE,error=FALSE}
...
```{r psorImmport,message=FALSE,warning=FALSE,error=FALSE}
...
```{r immportWincorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r immportBwcorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r immportNetdat,message=FALSE,warning=FALSE,error=FALSE}
...
```{r foodImmport,message=FALSE,warning=FALSE,error=FALSE}
...
```{r immportMetab,message=FALSE,warning=FALSE,error=FALSE}
...
```{r immportFullmetab,message=FALSE,warning=FALSE,error=FALSE}
...
```{r foodMetab,message=FALSE,warning=FALSE,error=FALSE}
vnames=c('food','metab')
...
note: food needs to be X variable because auto.arima doesn't handle binary Y variable
```{r foodFullmetab,message=FALSE,warning=FALSE,error=FALSE}
...
#### behav vs. metabolsm
```{r behavMetab,message=FALSE,warning=FALSE,error=FALSE}
...
```{r behavFullmetab,message=FALSE,warning=FALSE,error=FALSE}
...
```{r metabWincorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r fullmetabWincorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r metabBwcorr,message=FALSE,warning=FALSE,error=FALSE}
...
####metabolism vs. within-network connectivity (full set of metabolites)
```{r fullmetabBwcorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r metabMetab,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wincorrWincorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r bwcorrBwcorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wincorrNetdat,message=FALSE,warning=FALSE,error=FALSE}
...
```{r bwcorrNetdat,message=FALSE,warning=FALSE,error=FALSE}
...
#### network measures
```{r netdatNetdat,message=FALSE,warning=FALSE,error=FALSE}
...
```{r foodWincorr,message=FALSE,warning=FALSE,error=FALSE}
...
```{r foodBehav,message=FALSE,warning=FALSE,error=FALSE}
food$apples=NULL  
...
#### FD vs. behavior
```{r fdBehav,message=FALSE,warning=FALSE,error=FALSE}
...
#### FD vs. RNA-seq
```{r fdWgcna,message=FALSE,warning=FALSE,error=FALSE}
vnames=c('fd','wgcna')
...
```{r fdMetab,message=FALSE,warning=FALSE,error=FALSE}
...
#### FD vs. wincorr
```{r fdWincorr,message=FALSE,warning=FALSE,error=FALSE}
...
#### FD vs. netdat
```{r fdNetdat,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wgcnaWgcna,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wgcnaMetab,message=FALSE,warning=FALSE,error=FALSE}
...
```{r wgcnaFullmetab,message=FALSE,warning=FALSE,error=FALSE}
...
```{r foodWgcna,message=FALSE,warning=FALSE,error=FALSE}
