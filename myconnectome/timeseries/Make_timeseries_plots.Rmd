...
require(knitr)
require(markdown)
setwd("/Users/poldrack/data_unsynced/myconnectome/timeseries")
source("/Users/poldrack/code/myconnectome/myconnectome/timeseries/load_myconnectome_data.R")
source("/Users/poldrack/code/myconnectome/myconnectome/timeseries/data_utilities.R")
source("/Users/poldrack/code/myconnectome/myconnectome/timeseries/timeseries_helpers.R")
source("/Users/poldrack/code/myconnectome/myconnectome/timeseries/est_bivariate_arima_model.R")
...
mod_des=read.table(sprintf('%s/rna-seq/WGCNA/module_descriptions.txt',sep='\t')
data_names=c()
for (i in 1:(dim(datamat)[2]-1)) {
  	data_names=rbind(data_names,sprintf('%s:%s',names(datamat)[i],mod_des$V2[i]))
		}
...
for (varnum in 1:(dim(datamat)[2]-1)) {
  ...
  pdf(file=sprintf('/Users/poldrack/data/selftracking/rna-seq/timeseries_plots/module%03d.pdf',varnum),width=12,height=4)
