...
filenames=read.table('http://web.stanford.edu/group/poldracklab/myconnectome-data/snyderome/htcount_files.txt')
...
cdsFull=newCountDataSetFromHTSeqCount(htcount_files,
          directory="http://web.stanford.edu/group/poldracklab/myconnectome-data/snyderome")
