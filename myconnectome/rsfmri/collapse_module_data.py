...
def collapse_module_data():
    outdir_bwmod=os.path.join(basedir,'rsfmri/bwmod_corr_data')
    outdir_winmod=os.path.join(basedir,'rsfmri/winmod_corr_data')
    ...
    numpy.savetxt(os.path.join(basedir,'rsfmri/module_within_corr.txt'),mmc_win)
    numpy.savetxt(os.path.join(basedir,'rsfmri/module_between_corr.txt'),mmc_bw)
