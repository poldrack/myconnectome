...
metab_full=load_metab_data(use_clustered_data=FALSE)
...
```{r  results="asis"}
kable_wrap(out.dat.behav_behav[out.dat.behav_behav$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.wincorr_behav[out.dat.wincorr_behav$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.wgcna_behav[out.dat.wgcna_behav$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.wgcna_wincorr[out.dat.wgcna_wincorr$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.immport_behav[out.dat.immport_behav$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.immport_wincorr[out.dat.immport_wincorr$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.food_immport[out.dat.food_immport$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.immport_metab[out.dat.immport_metab$pval_bh<fdr_thresh,])
...
out.dat.immport_metab_full=est_bivariate_arima_model(immport,metab_full,spacing='1 week')
```

```{r  results="asis"}
kable_wrap(out.dat.immport_metab_full[out.dat.immport_metab_full$pval_bh<fdr_thresh,])
write.table(out.dat.immport_metab_full,file=paste(OUTPUT_DIR,'out.dat.immport_metabfull.txt',sep='/'))
```
...
```{r  results="asis"}
kable_wrap(out.dat.food_metab[out.dat.food_metab$pval_bh<fdr_thresh,])
...
out.dat.food_metab_full=est_bivariate_arima_model(food,metab_full,spacing='1 week')
```

```{r  results="asis"}
kable_wrap(out.dat.food_metab_full[out.dat.food_metab_full$pval_bh<fdr_thresh,])
write.table(out.dat.food_metab_full,file=paste(OUTPUT_DIR,'out.dat.food_metabfull.txt',sep='/'))
```
...
```{r  results="asis"}
kable_wrap(out.dat.behav_metab[out.dat.behav_metab$pval_bh<fdr_thresh,])
...
out.dat.behav_metab_full=est_bivariate_arima_model(behav_keep_no_tth,metab_full,spacing='1 week')
```

```{r  results="asis"}
kable_wrap(out.dat.behav_metab_full[out.dat.behav_metab_full$pval_bh<fdr_thresh,])
write.table(out.dat.behav_metab_full,file=paste(OUTPUT_DIR,'out.dat.behav_metabfull.txt',sep='/'))
```
...
```{r  results="asis"}
kable_wrap(out.dat.metab_wincorr[out.dat.metab_wincorr$pval_bh<fdr_thresh,])
...
out.dat.metab_full_wincorr=est_bivariate_arima_model(metab_full,wincorr,spacing='1 week')
```

```{r  results="asis"}
kable_wrap(out.dat.metab_full_wincorr[out.dat.metab_full_wincorr$pval_bh<fdr_thresh,])
write.table(out.dat.metab_full_wincorr,file=paste(OUTPUT_DIR,'out.dat.metabfull_wincorr.txt',sep='/'))
```
...
```{r  results="asis"}
kable_wrap(out.dat.wincorr_wincorr[out.dat.wincorr_wincorr$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.food_wincorr[out.dat.food_wincorr$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.food_behav[out.dat.food_behav$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.fd.behav[out.dat.fd.behav$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.fd.rnaseq[out.dat.fd.rnaseq$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.fd.metab[out.dat.fd.metab$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.fd.wincorr[out.dat.fd.wincorr$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.wgcna_wgcna[out.dat.wgcna_wgcna$pval_bh<fdr_thresh,])
...
```{r  results="asis"}
kable_wrap(out.dat.wgcna_metab[out.dat.wgcna_metab$pval_bh<fdr_thresh,])
...
out.dat.wgcna_metab_full=est_bivariate_arima_model(rnaseq_wgcna,metab_full,spacing='1 week')
```

```{r  results="asis"}
kable_wrap(out.dat.wgcna_metab_full[out.dat.wgcna_metab_full$pval_bh<fdr_thresh,])
write.table(out.dat.wgcna_metab_full,file=paste(OUTPUT_DIR,'out.dat.wgcna_metabfull.txt',sep='/'))
```
...
```{r  results="asis"}
kable_wrap(out.dat.wgcna_food[out.dat.wgcna_food$pval_bh<fdr_thresh,])
