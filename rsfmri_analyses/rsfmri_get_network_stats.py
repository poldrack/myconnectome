...
sessdata=numpy.vstack((eff,clust,modularity_multi,power_exp,rcc_at_cutoff,gcsize,apl))
varnames=['eff','clust','modularity_multi','power_exp','rcc_at_cutoff','gcsize','apl']
...
lh=nibabel.gifti.giftiio.read('/corral-repl/utexas/poldracklab/data/selftracking/parcellation/all_selected_L_parcel_renumbered.func.gii')
rh=nibabel.gifti.giftiio.read('/corral-repl/utexas/poldracklab/data/selftracking/parcellation/all_selected_R_parcel_renumbered.func.gii')
